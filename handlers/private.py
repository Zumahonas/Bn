...
async def start(_, message: Message):
                ...
                "https://i.ibb.co/82sJv0r/picture-1653467249780.png",
                caption=(f"""**Merhaba {message.from_user.mention} 🎵\nBen {bot}!\nSesli sohbetlerde müzik çalabilen botum. Ban yetkisiz, Ses yönetimi yetkisi verip, Asistanı gruba ekleyiniz.\n\nDüzen Tasarım [Rapid Destek🎙️](https://t.me/Rapiddestek).**"""),
         reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰Beni Grubuna Ekle ❱ ➕", url=f"https://t.me/RapidMusicBot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/Rapidmusicasistant"
                    ),
                    InlineKeyboardButton(
                        "💬 Destek", url="https://t.me/RapidDestek"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/Rapiddestek"
                    )
                ]
    ...
    await query.edit_message_text(f"""**Merhaba {query.from_user.mention} 🎵\nBen {bot}!\nSesli sohbetlerde müzik çalabilen botum. Ban yetkisiz, Ses yönetimi yetkisi verip, Asistanı gruba ekleyiniz.\n\nDüzen Tasarım [Rapid Destek 🎙️](https://t.me/Rapiddestek).**""",
         reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Grubuna Ekle ❱ ➕", url=f"https://t.me/RapidMusicbot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
